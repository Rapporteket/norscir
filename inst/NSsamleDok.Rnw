...
<<FigNevrNivaaInnUtEget, echo=FALSE, message=FALSE>>=
	NorScir::FigAndelStabel(NSdata,   valgtVar='NevrNivaaInnUt', datoFra=datoFra, datoTil=datoTil,
...
<<FigAlder, echo=FALSE, message=FALSE>>=
	NorScir::FigFordeling(NSdata,   outfile='', valgtVar='Alder', datoFra=datoFra, datoTil=datoTil,
			minald=minald, maxald=maxald, traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
...
<<FigOpphTot, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='OpphTot', datoFra=datoFra, datoTil=datoTil,
			minald=minald, maxald=maxald, traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
...
<<FigDagerTilRehab, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='DagerTilRehab', datoFra=datoFra, datoTil=datoTil,
			minald=minald, maxald=maxald, traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
...
<<FigDagerRehab, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='DagerRehab', datoFra=datoFra, datoTil=datoTil,
			traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
...
<<FigPermisjon, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='Permisjon', datoFra=datoFra, datoTil=datoTil,
			traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
...
\scalebox{\Sexpr{s1}}{
<<FigUtTil, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='UtTil', datoFra=datoFra, datoTil=datoTil,
			minald=minald, maxald=maxald, traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
...
<<FigSkadeArsak, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='SkadeArsak', datoFra=datoFra, datoTil=datoTil,
			minald=minald, maxald=maxald, traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
  \caption{Skadeårsak}
...
<<FigPustehjelp, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='Pustehjelp', datoFra=datoFra, datoTil=datoTil,
			minald=minald, maxald=maxald, traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
...
<<FigASIAinn, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='AAis', datoFra=datoFra, datoTil=datoTil,
			minald=minald, maxald=maxald, traume=traume, enhetsUtvalg=1,
      reshID=reshID, sml=sml, hentData=0)
@
}
...
<<FigASIAut, echo=FALSE>>=
	NorScir::FigFordeling(NSdata,   valgtVar='FAis', datoFra=datoFra, datoTil=datoTil,
			minald=minald, maxald=maxald, traume=traume, enhetsUtvalg=1, reshID=reshID, sml=sml, hentData=0)
@
}
...
<<FigAlderGjsn, echo=FALSE>>=
	NorScir::FigMeanMed(NSdata,   valgtVar='Alder', datoFra=datoFra, datoTil=datoTil,
...
<<FigDagerRehabGjsn, echo=FALSE>>=
	NorScir::FigMeanMed(NSdata,   valgtVar='DagerRehab', datoFra=datoFra, datoTil=datoTil,
		valgtMaal='', minald=minald, maxald=maxald, erMann=erMann, traume=traume,
    hentData=0)
@
}
...
<<FigDagerTilRehabGjsn, echo=FALSE>>=
	NorScir::FigMeanMed(NSdata,   valgtVar='DagerTilRehab', datoFra=datoFra, datoTil=datoTil,
		valgtMaal='', minald=minald, maxald=maxald, erMann=erMann, traume=traume,
    hentData=0)
@
}
...
<<FigPermisjonGjSn, echo=FALSE>>=
	NorScir::FigMeanMed(NSdata,   valgtVar='Permisjon', datoFra=datoFra, datoTil=datoTil,
		valgtMaal='', minald=minald, maxald=maxald, erMann=erMann, traume=traume,
    hentData=0)
@
}
...
<<FigOpphTotGjsn, echo=FALSE>>=
	NorScir::FigMeanMed(NSdata,   valgtVar='OpphTot', datoFra=datoFra, datoTil=datoTil,
		valgtMaal='', minald=minald, maxald=maxald, erMann=erMann, traume=traume,
    hentData=0)
@
}
